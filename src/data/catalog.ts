...
import nakedNoiseImg from "@/assets/naked-noise.webp";
import extrovertImg from "@/assets/extrovert.webp";
import noExitImg from "@/assets/no-exit.webp";
import egoImg from "@/assets/ego.webp";
import burningAttractionImg from "@/assets/burning-attraction.webp";
import ego10mlImg from "@/assets/ego-10ml.webp";
import nakedNoise10mlImg from "@/assets/naked-noise-10ml.webp";
import noExit10mlImg from "@/assets/no-exit-10ml.webp";
import extrovert10mlImg from "@/assets/extrovert-10ml.webp";
import divorce15mlImg from "@/assets/divorce-15ml.webp";
import seductionImg from "@/assets/seduction.webp";
import suckEyesImg from "@/assets/suck-eyes.webp";
import suicideKissImg from "@/assets/suicide-kiss.webp";
import evesTemptationImg from "@/assets/eves-temptation.webp";
import moodSwingsImg from "@/assets/mood-swings.webp";
import provocativeWineImg from "@/assets/provocative-wine.webp";
import dopamineImg from "@/assets/dopamine.webp";
import suckEyes10mlImg from "@/assets/suck-eyes-10ml.webp";
import seduction10mlImg from "@/assets/seduction-10ml.webp";
...
import burningAttraction1 from "@/assets/burning-attraction-1.webp";
import burningAttraction2 from "@/assets/burning-attraction-2.webp";
import burningAttraction3 from "@/assets/burning-attraction-3.webp";
import dopamine1 from "@/assets/dopamine-1.webp";
import dopamine2 from "@/assets/dopamine-2.webp";
import dopamine3 from "@/assets/dopamine-3.webp";
import dopamine4 from "@/assets/dopamine-4.webp";
import dopamine5 from "@/assets/dopamine-5.webp";
import evesTemptation1 from "@/assets/eves-temptation-1.jpeg";
import evesTemptation2 from "@/assets/eves-temptation-2.webp";
import evesTemptation3 from "@/assets/eves-temptation-3.webp";
...
import evesTemptation6 from "@/assets/eves-temptation-6.webp";
import evesTemptation7 from "@/assets/eves-temptation-7.webp";
import nakedNoise1 from "@/assets/naked-noise-1.webp";
import nakedNoise2 from "@/assets/naked-noise-2.webp";
import provocativeWine1 from "@/assets/provocative-wine-1.webp";
import provocativeWine2 from "@/assets/provocative-wine-2.webp";
import provocativeWine3 from "@/assets/provocative-wine-3.webp";
import seduction1 from "@/assets/seduction-1.webp";
import seduction2 from "@/assets/seduction-2.webp";
import seduction3 from "@/assets/seduction-3.webp";
import seduction4 from "@/assets/seduction-4.jpeg";

// Divorce Lotion Imports
import divorceLotionProduct from "@/assets/divorce-lotion-product.webp";
import divorceLotionHero from "@/assets/divorce-lotion-hero.webp";
import divorceLotionGallery1 from "@/assets/divorce-lotion-gallery1.webp";
import divorceLotionGallery2 from "@/assets/divorce-lotion-gallery2.webp";
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    img: nakedNoiseImg,
    hr: "8 HR",
    description: "ഈ പെർഫ്യൂമിനെ കുറിച്ച് പറയുകയാണെങ്കിൽ വാങ്ങിയ പൈസയ്ക്ക് രണ്ടിരട്ടി ലാഭം തരുന്ന പ്രോഡക്റ്റ് ഇത് ഒരു കസ്റ്റമർക്ക് കാഴ്ചവെക്കുന്ന രീതി രണ്ടു ആളുകളിൽ നിന്ന് ഒരാളെ മാറ്റി 2 മീറ്റർ ദൂരത്തോട്ട് നിർത്തുന്നു . അവിടെവച്ച് അയാൾക്ക് ഈ പെർഫ്യൂം ദേഹത്ത് അടിച്ചു കൊടുക്കുന്നു മറുഭാഗത്ത് നിൽക്കുന്ന ആൾക്ക് ഒരു മിനിറ്റിനുള്ളിൽ ഈ സുഗന്ധം അനുഭവിച്ചറിയാൻ സാധിച്ചാൽ പ്രോഡക്റ്റ് വിൽക്കത്തൊള്ളൂ അടങ്ങിയിരിക്കുന്ന കാര്യങ്ങൾ പാഷൻ ഫ്രൂട്ടിന്റെ വീര്യം കൂടെ ഊതും അതിനിടയിൽ കൂടെ കാന്റീ സുഗന്ധവും. ഇത് ഉപയോഗിച്ച് കടന്നുപോകുമ്പോൾ തലതിരിച്ചു നോക്കാൻ തോന്നിക്കുന്ന വിധം ആകർഷണ മാക്കപ്പെട്ടത്. ഉപയോഗിച്ചതിനു ശേഷം ഒരു വീട്ടിൽ ഗസ്റ്റ് ആയി പോവുകയോ ഒരു കടയിൽ കയറി സാധനം വാങ്ങാൻ പോവുകയോ ചെയ്താൽ അവിടെയുള്ളവർ തമ്മിൽ നോക്കി വന്നിരിക്കുന്ന ആളെ കുറിച്ച് സംസാരവിഷയം ആക്കുന്ന വീര്യം അതാണ് നേക്കഡ് നോയിസ്",
    base: "OUD_BASE",
    pricing: { "10 ml": 310, "15 ml": 600, "50 ml": 1300 },
    outOfStock: ["10 ml"],
  ...
  // --- FRESH BASE ---
  {
    ...
    base: "FRESH_BASE",
    pricing: { "10 ml": 400, "15 ml": 600, "50 ml": 1400 },
  ...
  },
  {
    ...
    img: messiProductImg,
    hr: "24 Hours",
    description: "ഒരു പുരുഷന് വേണ്ട സുഗന്ധം വളരെ മസ്കുലിൻ നനഞ്ഞ ലതറിന്റെ മത്തുപിടിപ്പിക്കും വിധം സുഗന്ധത്താൽ പൊതിഞ്ഞത്. നീണ്ട നേരം നിലനിൽക്കുന്നത്. ഒരു മരണവീട്ടിൽ അറിയാതെ പോലും ഉപയോഗിച്ചു അടിച്ചു ഉപയോഗിച്ചു പോകാൻ കഴിയാത്തതു. ചുറ്റുപാട് നിൽക്കുന്നവർക്ക് വളരെ ആകാംക്ഷയേറിയതും കാഠിന്യത്താൽ ഗുണമേന്മയേറിയതും അവസാനം ലഭിച്ചു.",
    base: "MESSI_EDITION",
